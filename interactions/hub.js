...
const chapterNames={top:'배움 · 일 · 문화',philosophy:'SYNK · 회사 소개',work:'SYNK · 체험과 가이드',lab:'LAB · 한국어 교육',shift:'SHIFT · 비즈니스와 커리어',pulse:'PULSE · 문화 콘텐츠',contact:'SYNK · 문의와 협업'};
...
function selectVolume(index){
 ...
 roadmap.querySelector('[data-roadmap-pair]').textContent=index<2?'회화 연결 · 시냅스 톡 1권':index<5?'회화 연결 · 시냅스 톡 2권':'코어 심화 · 전문적이고 추상적인 주제로 말하기';
