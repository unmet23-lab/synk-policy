...
export function initOrbConversation(){
 ...
 function open(mode,{focus=false,remember=false}={}){
  workspace.hidden=false;root.classList.add('is-open');root.dataset.mode=mode;launch.setAttribute('aria-expanded','true');launch.setAttribute('aria-label',"Go to the question field");close.hidden=false;
