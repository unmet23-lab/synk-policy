...
const pending=fetch('/knowledge.json?v=2026-09-15-selected-experiences-copy-495a9a4b3e').then(r=>{if(!r.ok)throw new Error('자료를 불러오지 못했어요.');return r.json();}).then(data=>{
